...
class ModelArguments:
    ...
    stop_after_n_steps: int = field(
        default=None, metadata={"help": "early stop"}
    )
...
@dataclass
class DataArguments:
    hard_neg_file :str = field(
        default=None, metadata={"help": "static hard negative"}
    )
    ...
    train_file: str = field(
        default=None, metadata={"help": "Path to train data of new format"}
    )
    mapped_train_file: str = field(
        default=None, metadata={"help": "Path to mapped train data"}
    )
    dataset_proc_num: int = field(
        default=8, metadata={"help": "num of process for mapping"}
    )
...
class RetrieverTrainingArguments(TrainingArguments):
    ...
    contrastive_loss_weight: Optional[float] = field(default=0.01)
    loss_type: Optional[str] = field(default='myloss')
